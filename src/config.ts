export const DEFAULT_START_NODE = {
  ...
  imageDescription: `A simple gray stone found on the side of the road`,
}
...
export const GENERATE_IMAGES_ASAP = false

export const DEPRECATION_DATE = new Date('2023-06-25T20:18:58.319Z')
